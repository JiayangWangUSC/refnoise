...
def data_transform(kspace_noisy, kspace_clean, ncc_effect, sense_maps):
    ...
    return kspace_noisy, ncc_effect, sense_maps
...
#recon_modol = torch.load("/project/jhaldar_118/jiayangw/refnoise/model/modl_ncc_acc4")
...
for epoch in range(max_epochs):
    print("epoch:",epoch+1)
    batch_count = 0    
    for kspace, ncc_effect, sense_maps in train_dataloader:
