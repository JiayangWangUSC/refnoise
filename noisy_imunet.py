...
recon_model = torch.load('/project/jhaldar_118/jiayangw/refnoise/model/imunet_mae_acc4_epoch100')
...
for epoch in range(max_epochs):
    ...
    if (epoch + 1)%20 == 0:
        torch.save(recon_model,"/project/jhaldar_118/jiayangw/refnoise/model/imunet_mae_acc4_epoch"+str(epoch+101))
