...
recon_model = torch.load("/project/jhaldar_118/jiayangw/refnoise/model/varnet_mae_acc4_cascades"+str(cascades)+"_channels"+str(chans)+"_epoch100")
# %% training settings
...
for epoch in range(max_epochs):
    ...
    if (epoch + 1)%20 == 0:
        torch.save(recon_model,"/project/jhaldar_118/jiayangw/refnoise/model/varnet_mae_acc4_cascades"+str(cascades)+"_channels"+str(chans)+"_epoch"+str(epoch+101))
